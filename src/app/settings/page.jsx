    ...
    <div className="min-h-screen flex flex-col bg-white dark:bg-gray-950">
      ...
      <main className="flex-1 p-4 sm:p-6 md:p-8 max-w-5xl mx-auto w-full">
        <div className="mb-8 md:mb-10">
          <h1 className="text-2xl md:text-3xl font-bold text-[#4068ec] dark:text-[#63D2FF] mb-2">Settings</h1>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 p-4 sm:p-6 mb-6 md:mb-8 backdrop-blur-sm dark:backdrop-blur-sm transition-all">
          <h2 className="text-lg md:text-xl font-semibold text-[#4068ec] dark:text-[#63D2FF] mb-4 md:mb-6">Appearance</h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-4">
            <button
              ...
              className={`flex items-center justify-center flex-col gap-2 md:gap-3 p-4 md:p-6 rounded-xl transition-all ${
                theme === "light" 
                  ? "bg-gradient-to-br from-blue-50 to-blue-100 shadow-md text-[#4068ec] border border-[#4068ec]/20 dark:from-blue-900/30 dark:to-blue-900/20 dark:border-[#63D2FF]/30 dark:text-[#63D2FF]" 
            ...
            >
              <Sun className={`h-6 w-6 md:h-7 md:w-7 ${theme === "light" ? "text-[#4068ec] dark:text-[#63D2FF]" : ""}`} />
            ...
            >
              <Moon className={`h-6 w-6 md:h-7 md:w-7 ${theme === "dark" ? "text-[#4068ec] dark:text-[#63D2FF]" : ""}`} />
        ...
        {settingsSections.map((section, index) => (
          <div key={index} className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 p-4 sm:p-6 mb-6 md:mb-8 backdrop-blur-sm dark:backdrop-blur-sm transition-all">
            <h2 className="text-lg md:text-xl font-semibold text-[#4068ec] dark:text-[#63D2FF] mb-4 md:mb-6">{section.title}</h2>
              ...
              {section.items.map((item, itemIndex) => (
                ...
                >
                  <div className="flex items-center gap-3 md:gap-4">
                    <div className="text-[#4068ec] dark:text-[#63D2FF] p-2 rounded-full bg-[#4068ec]/5 dark:bg-[#63D2FF]/10 group-hover:bg-[#4068ec]/10 dark:group-hover:bg-[#63D2FF]/20 transition-colors">
                      {item.icon}
                    </div>
                    <div>
                  ...
                  <ChevronRight className="h-5 w-5 text-gray-400 dark:text-gray-500 group-hover:text-[#4068ec] dark:group-hover:text-[#63D2FF] transition-colors flex-shrink-0" />
                </Link>
              ))}
            </div>
          </div>
